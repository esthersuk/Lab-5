...
function sumArray(inputArray){ //eslint-disable-line
  var sum1 = sum(inputArray[0], inputArray[1])[0];
  var sum2 = sum(sum1, inputArray[2])[0];
  var inputTest = inputArray + ' was passed in as an array of numbers, and ' + sum2 + ' is their sum.';
  return [sum2, inputTest];
}
...
function multiplyArray(potatoArray){ //eslint-disable-line
  var multiply1 = multiply(potatoArray[0], potatoArray[1])[0];
  var multiply2 = multiply(multiply1, potatoArray[2])[0];
  var inputArray =  'The numbers ' + potatoArray + ' have a product of ' + multiply2 + '.';
  return [multiply2, inputArray];
}
